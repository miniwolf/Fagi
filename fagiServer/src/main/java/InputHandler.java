...
public class InputHandler {
    ...
    public InputHandler(InputAgent inputAgent, OutputAgent out, ConversationHandler conversationHandler) {
    ...
    private Object handleDeleteFriend(DeleteFriend arg) {
        ...
        return Data.getUser(inputAgent.getUsername()).removeFriend(arg.getFriendUsername());
    }

    private Object handleDeleteFriendRequest(DeleteFriendRequest arg) {
        System.out.println("DeleteFriendRequest");
        return Data.getUser(inputAgent.getUsername()).removeFriendRequest(arg.getFriendUsername());
    }
    ...
    private Object handleFriendRequest(FriendRequest arg) {
        ...
        Response response = Data.getUser(inputAgent.getUsername()).requestFriend(arg);
        if (!(response instanceof AllIsWell)) {
            return response;
        }
